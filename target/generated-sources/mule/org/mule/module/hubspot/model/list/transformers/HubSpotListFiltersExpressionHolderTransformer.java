...
public class HubSpotListFiltersExpressionHolderTransformer
    ...
    implements DiscoverableTransformer, MessageTransformer
{
    ...
    public boolean isSourceTypeSupported(Class<?> aClass) {
        return (aClass == HubSpotListFiltersExpressionHolder.class);
    }

    public boolean isSourceDataTypeSupported(DataType<?> dataType) {
        return (dataType.getType() == HubSpotListFiltersExpressionHolder.class);
    }

    public List<Class<?>> getSourceTypes() {
        return Arrays.asList(new Class<?> [] {HubSpotListFiltersExpressionHolder.class });
    }

    public List<DataType<?>> getSourceDataTypes() {
        return Arrays.asList(new DataType<?> [] {DataTypeFactory.create(HubSpotListFiltersExpressionHolder.class)});
    }
    ...
    public Class<?> getReturnClass() {
        return HubSpotListFilters.class;
    }
    ...
    public DataType<?> getReturnDataType() {
        return DataTypeFactory.create(HubSpotListFilters.class);
    }
        ...
        throws TransformerMessagingException
    {
        ...
        HubSpotListFiltersExpressionHolder holder = ((HubSpotListFiltersExpressionHolder) src);
        HubSpotListFilters result = new HubSpotListFilters();
        try {
            final List<HubSpotListFilter> _transformedFilters = ((List<HubSpotListFilter> ) evaluateAndTransform(this.muleContext, event, HubSpotListFiltersExpressionHolder.class.getDeclaredField("_filtersType").getGenericType(), null, holder.getFilters()));
            result.setFilters(_transformedFilters);
